 ...
 *
 *
 * In BullsEyeGame I have multiple mutable properties that will
 * be changed multiple times throughout the game. If I use struct
 * here then I have to use the mutating keyword before every method
 * where the properties will be changed. This will be verbose to read.
 *
 * Also, if I choose struct here, to change the property I have to
 * use var instead of let for the BullsEyeGame object. Because I have
 * to call mutating methods to change properties. var will allow me to
 * change the object itself. This might lead to a bug in the future.
 * Here I want the reference to be fixed and I want to change the
 * properties of the object. I this scenario I think the class is a better choice.
 * 
 *
 **/
